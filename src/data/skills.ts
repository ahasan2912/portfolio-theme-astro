...
export const skills: Skill[] = [
  ...
  { label: 'Redux & Redux Toolkit', icon: '/svg/redux.svg', categoryId: 'tools', level: 85 },
  ...
  { label: 'Vitest', icon: '/svg/vitest.svg', categoryId: 'tools', level: 86 },
  { label: 'Shadcn UI', icon: '/svg/shadcn.svg', categoryId: 'tools', level: 86 },
  ...
  { label: 'Firebase', icon: '/svg/firebase.svg', categoryId: 'database', level: 76 },
]